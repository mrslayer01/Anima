...
export const ABF_ADVANTAGES = {
    ...
    addOnePointToACharacteristic: createAdvantage({
        ...
        restriction: "Strength, Dexterity, Agility, and Constitution cannot be increased to more than 11 through this Advantage. Intelligence, Power, Willpower, and Perception cannot be increased to more than 13 through this Advantage.",
    ...
    artifact: createAdvantage({
        name: "Artifact",
        type: "Common",
        effects: "The character possesses a mystical device of significant power. Its abilities are determined collaboratively with the Game Master.",
        restriction: "",
    ...
    ambidextrous: createAdvantage({
        name: "Ambidextrous",
        type: "Common",
        effects: "The character can use both hands equally well. In combat, he suffers only –10 to attacks made with an additional weapon.",
        restriction: "",
        special: "",
        cost: "1",
    ...
    charm: createAdvantage({
        name: "Charm",
        type: "Common",
        effects: "The character naturally receives positive reactions from strangers and may be treated more permissively.",
        restriction: "",
    ...
    disquieting: createAdvantage({
        name: "Disquieting",
        type: "Common",
        effects: "The character can make others uneasy at will, discouraging aggression or influencing intimidating individuals.",
        restriction: "",
        special: "The exact limits are determined by the Game Master.",
        cost: "1",
    ...
    animalAffinity: createAdvantage({
        ...
        type: "Common",
        effects: "The character gains positive reactions from animals and can communicate basic intentions with them.",
        restriction: "",
    ...
    dangerSense: createAdvantage({
        name: "Danger Sense",
        type: "Common",
        effects: "The character cannot be taken by surprise unless the attacker’s Initiative exceeds his by 150 or more.",
        restriction: "",
        special: "",
        cost: "2",
    ...
    beenAround: createAdvantage({
        name: "Been Around",
        type: "Common",
        effects: "The character begins with 50, 100, or 150 additional Experience Points, depending on points spent.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    accessToNaturalPsychicPowers: createAdvantage({
        ...
        type: "Common",
        effects: "The character can use one Psychic Ability instinctively once per minute without rolling. Additional points increase the difficulty tier.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    repeatACharacteristicsRoll: createAdvantage({
        ...
        type: "Common",
        effects: "Allows the player to roll one additional die during Characteristic generation and replace one previous result.",
    ...
    martialMastery: createAdvantage({
        ...
        type: "Common",
        effects: "Adds 40, 80, or 120 points to the character’s Martial Knowledge, depending on points spent.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    kiRecovery: createAdvantage({
        name: "Ki Recovery",
        type: "Common",
        effects: "The character recovers 1 Ki every 10 minutes. Additional points reduce the interval to 5 minutes and 1 minute.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    jackOfAllTrades: createAdvantage({
        ...
        type: "Common",
        effects: "The character never suffers the –30 penalty for untrained Secondary Abilities and gains +10 to all of them.",
        restriction: "",
        special: "",
        cost: "2",
    ...
    naturalArmor: createAdvantage({
        name: "Natural Armor",
        type: "Common",
        effects: "Grants natural armor 2 against all attacks except energy-based ones, without applying armor penalties.",
        restriction: "",
        special: "",
        cost: "1",
    ...
    mysticalArmor: createAdvantage({
        name: "Mystical Armor",
        type: "Common",
        effects: "Grants natural armor 4 against energy-based attacks, without applying armor penalties.",
        restriction: "",
        special: "",
        cost: "1",
    ...
    startingWealth: createAdvantage({
        ...
        type: "Common",
        effects: "This Advantage provides starting money or equipment valued at 2,000 gold crowns (GC). Further points spent increase this amount to 5,000 and 10,000, respectively.",
        restriction: "The Game Master may prefer to give a different amount of money tailored to his game. In this case, both the GM and the player should decide the amount.",
        special: "",
        cost: "1, 2, 3",
    ...
    regeneration: createAdvantage({
        ...
        type: "Common",
        effects: "This Advantage increases the character’s Regeneration by two levels. Spending additional points increases Regeneration by four and six levels, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    elan: createAdvantage({
        name: "Elan",
        type: "Common",
        effects: "The character has Elan 25 for the entity he chooses. Spending additional points increases the level to 45 and 60, respectively. Thus, a character whose player spent 2 Creation Points on this Advantage would have Elan of 45 with the particular Shajad or Beryl whose favor he enjoys.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
        description: "A character with this Advantage has attracted the attention of a Shajad or a Beryl. Generally, this means that an ancestor of the character was bound to the being and it still maintains some type of bond with all the members of the family. It is also possible that this attention is due to some actions the character has taken. At the moment, he enjoys its favor – although after the player begins playing his character, the relationship will depend on how he behaves."
    }),
    ...
    theGift: createAdvantage({
        ...
        special: "",
        cost: "2",
        description: "The character can feel and control supernatural energies inherent within his own soul."
    }),

    seeSupernatural: createAdvantage({
        name: "See Supernatural",
        type: "Common",
        effects: "The character sees supernatural things—including magic and psychic matrices—as spiritual creatures. He does not apply the blinded penalty in any of these situations.",
        restriction: "",
        special: "",
        cost: "1",
    ...
    nightVision: createAdvantage({
        name: "Night Vision",
        type: "Common",
        effects: "The character may ignore any penalty caused by the dark—except for magically induced dark or absolute lack of light, in which case the penalty is reduced by half.",
        restriction: "",
        special: "",
        cost: "1",
        description: "The character can see in the dark and adapt quickly to changes in light intensity."
    }),

    fortunate: createAdvantage({
        name: "Fortunate",
        type: "Common",
        effects: "The character will never suffer the negative effects of a trap or an attack determined solely by chance. The limits of this Advantage must be decided by the Game Master.",
        restriction: "",
        special: "",
        cost: "1",
    ...
    quickReflexes: createAdvantage({
        name: "Quick Reflexes",
        type: "Common",
        effects: "Grants a special bonus of +25 to a character’s Initiative score. Spending additional Creation Points increases the bonus to +45 and +60, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
        description: "The character has exceptional reflexes that allow him to respond quickly to any situation."
    }),

    learning: createAdvantage({
        name: "Learning",
        type: "Common",
        effects: "The character gains an additional 3 Experience Points when the Game Master grants points at the end of each game session. Spending additional Creation Points increases the benefit to 6 and 9 points, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    naturalLearner: createAdvantage({
        ...
        type: "Common",
        effects: "Grants a special modifier of +10 per level in a single Secondary Ability. Spending additional points increases the bonus to +20 and +30, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    naturalLearnerField: createAdvantage({
        ...
        type: "Common",
        effects: "Grants a special +5 per level bonus to all Secondary Abilities in a field. Spending an additional point increases the bonus to +10.",
        restriction: "",
        special: "",
        cost: "2, 3",
        description: "The character improves naturally in all Secondary Abilities within a chosen field."
    }),

    exceptionalMagicResistance: createAdvantage({
        name: "Exceptional Magic Resistance",
        type: "Common",
        effects: "Adds a special bonus of +25 to Magic Resistance (MR). Spending a second Creation Point increases the bonus to +50.",
        restriction: "",
        special: "",
        cost: "1, 2",
    ...
    exceptionalPhysicalResistance: createAdvantage({
        ...
        type: "Common",
        effects: "Adds a special bonus of +25 to Physical Resistance (PhR), Venom Resistance (VR), and Disease Resistance (DR). Spending a second Creation Point increases the bonus to +50.",
        restriction: "",
        special: "",
        cost: "1, 2",
        description: "The character possesses heightened resistance to physical attacks, poisons, and diseases."
    }),

    exceptionalPsychicResistance: createAdvantage({
        name: "Exceptional Psychic Resistance",
        type: "Common",
        effects: "Adds a special bonus of +25 to Psychic Resistance (PsR). Spending a second Creation Point increases the bonus to +50.",
        restriction: "",
        special: "",
        cost: "1, 2",
        description: "The character possesses strong mental barriers that protect him from psychic attacks."
    }),
    ...
    elementalCompatibility: createAdvantage({
        ...
        type: "Magic",
        effects: "The character has a special bonus of +20 to his MA and to his MR in the magical path that he chooses. When he uses spells of the opposed path, he has a penalty of –20 to his MA and to his MR. If the chosen path is Necromancy, apply the penalty to all other paths.",
        restriction: "",
        special: "",
        cost: "1",
        description: "The character is naturally compatible with the powers of a specific magical path and weaker in its opposite."
    }),
    ...
    naturalKnowledgeOfAPath: createAdvantage({
        ...
        cost: "1",
        description: "The character can cast certain spells naturally, without study, as if the Path responds instinctively to him."
    }),

    contestedSpellMastery: createAdvantage({
        name: "Contested Spell Mastery",
        type: "Magic",
        effects: "The character applies a bonus of +50 to his roll to calculate the result of a Collision against another beam.",
        restriction: "",
        special: "",
        cost: "1",
        description: "The character’s attack spells are stronger when clashing against another Supernatural Beam."
    }),

    aptitudeForMagicDevelopment: createAdvantage({
        name: "Aptitude for Magic Development",
        type: "Magic",
        effects: "A player can add 3 points to his character’s Intelligence to determine the maximum potential of the spell. This bonus is not applied to any other ability—not even to calculate the character’s level of magic.",
        restriction: "",
        special: "",
        cost: "1",
        description: "The character can achieve levels of spell power far beyond what his Intelligence would normally allow."
    }),

    halfAttunedToTheTree: createAdvantage({
        name: "Half-Attuned to the Tree",
        type: "Magic",
        effects: "The wizard has a special bonus of +20 to his MA and his MR in the five magical Paths of a segment of the Tree. In the rest, he has a penalty of –20 to his MA and his MR.",
        restriction: "Necromancy is not included in this Advantage.",
        special: "",
        cost: "2",
        description: "The character is naturally compatible with the magic of half of the Mystical Tree."
    }),

    improvedInnateMagic: createAdvantage({
        name: "Improved Innate Magic",
        type: "Magic",
        effects: "The innate spells of the wizard add +10 to their potential as indicated by their MA. Additional Creation Points increase the value to +20 and +30, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    superiorMagicRecovery: createAdvantage({
        ...
        type: "Magic",
        effects: "The character recovers his Zeon at twice his normal Zeonic regeneration rate. Spending additional Creation Points will triple or quadruple the normal rate.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
        description: "The character’s essence draws in magic more efficiently, regenerating power at an accelerated rate."
    }),
amplifySustainedPower: createAdvantage({
    ...
    psychicPointRecovery: createAdvantage({
        ...
        type: "Psychic",
        effects: "The character’s recovery rate for Psychic Points is 1 point every 10 minutes. Spending additional Creation Points increases the rate to 1 point every five minutes or every minute, respectively.",
        restriction: "",
        special: "",
        cost: "1, 2, 3",
    ...
    psychicFatigueResistance: createAdvantage({
        ...
        type: "Psychic",
        effects: "If a character fails in the use of one of his powers, he does not lose Fatigue when he has used up his available PP. Third level powers are not affected by this Advantage.",
        restriction: "",
        special: "",
        cost: "2",
    ...
    passiveConcentration: createAdvantage({
        ...
        special: "",
        cost: "2",
        description: "The character can concentrate in any situation, regardless of difficulty or complications."
    }),

    psychicInclination: createAdvantage({
        name: "Psychic Inclination",
        type: "Psychic",
        effects: "The character automatically gains one level of difficulty greater than normal when using the powers of a specific discipline.",
        restriction: "",
        special: "",
        cost: "2",
    ...
    focus: createAdvantage({
        name: "Focus",
        type: "Psychic",
        effects: "Psychic Points spent to improve Psychic Projection increase the ability by +20 instead of +10.",
        restriction: "",
        special: "",
        cost: "1",
        description: "The character can harness his ability more than normal and focus his powers on a particular objective."
    }),

    extremeConcentration: createAdvantage({
        name: "Extreme Concentration",
        type: "Psychic",
        effects: "The psychic doubles the bonus he normally gains from concentration. For example, if he concentrates for a full round, he gains +20 instead of +10.",
        restriction: "",
        special: "",
        cost: "2",
        description: "The character can concentrate far more intensely than most psychics, gaining greater benefits from his abilities."
    }),
